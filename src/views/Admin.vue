<template>
    <el-form :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-row>
            <el-col :span="12">
                <el-button type="primary" @click="onSubmit">添加仓库管理员信息</el-button>
        ...
        <el-form-item>
            <el-main style="max-height: 380px !important;border:solid 1px #E4E7ED;width:1200px;margin-top: 10px">
                <el-table :data="tableData" style="width: 100%">
                    <el-table-column prop="date" label="仓库管理员ID" width="180">
                    </el-table-column>
                    <el-table-column prop="name" label="仓库管理员姓名" width="180">
                    </el-table-column>
                    <el-table-column prop="address" label="性别">
                    </el-table-column>
                    <el-table-column prop="date" label="所属仓库ID" width="180">
                    </el-table-column>
